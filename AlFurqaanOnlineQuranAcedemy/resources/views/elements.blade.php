...
@section('content')
	...
	<section class="button-area">
		<div class="container border-top-generic">
			...
			<div class="button-group-area mt-40">
				<a href="#" class="genric-btn default circle arrow">Default<span class=""><i class="fas fa-long-arrow-alt-right"></i>  </span></a>
				<a href="#" class="genric-btn primary circle arrow">Primary<span><i class="fas fa-long-arrow-alt-right"></i></span></a>
				<a href="#" class="genric-btn success circle arrow">Success<span><i class="fas fa-long-arrow-alt-right"></i></span></a>
				<a href="#" class="genric-btn info circle arrow">Info<span><i class="fas fa-long-arrow-alt-right"></i></span></a>
				<a href="#" class="genric-btn warning circle arrow">Warning<span><i class="fas fa-long-arrow-alt-right"></i></span></a>
				<a href="#" class="genric-btn danger circle arrow">Danger<span><i class="fas fa-long-arrow-alt-right"></i></span></a>
			</div>
			<div class="button-group-area mt-10">
				<a href="#" class="genric-btn default-border circle arrow">Default<span><i class="fas fa-long-arrow-alt-right"></i></span></a>
				<a href="#" class="genric-btn primary-border circle arrow">Primary<span><i class="fas fa-long-arrow-alt-right"></i></span></a>
				<a href="#" class="genric-btn success-border circle arrow">Success<span><i class="fas fa-long-arrow-alt-right"></i></span></a>
				<a href="#" class="genric-btn info-border circle arrow">Info<span><i class="fas fa-long-arrow-alt-right"></i></span></a>
				<a href="#" class="genric-btn warning-border circle arrow">Warning<span><i class="fas fa-long-arrow-alt-right"></i></span></a>
				<a href="#" class="genric-btn danger-border circle arrow">Danger<span><i class="fas fa-long-arrow-alt-right"></i></span></a>
			</div>
			<div class="button-group-area mt-40">
