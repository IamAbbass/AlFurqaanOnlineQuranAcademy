					...
					<div class="single-post row">
						<div class="col-lg-3  col-md-3 meta-details">
							...
							<div class="user-details row">
								<p class="user-name col-lg-12 col-md-12 col-6"><a href="#">Mark wiens</a> <span ><i class="far fa-user"></i></span></p>
								<p class="date col-lg-12 col-md-12 col-6"><a href="#">12 Dec, 2017</a> <span><i class="far fa-calendar-alt"></i></span></p>
								<p class="view col-lg-12 col-md-12 col-6"><a href="#">1.2M Views</a> <span><i class="far fa-eye"></i></span></p>
								<p class="comments col-lg-12 col-md-12 col-6"><a href="#">06 Comments</a> <span><i class="far fa-comment"></i></span></p>
							</div>
						</div>
